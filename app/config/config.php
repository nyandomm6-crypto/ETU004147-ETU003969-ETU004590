...
$app->set('flight.base_url', '/web/ETU004147-ETU003969-ETU004590',);           // Base URL for your app. Change if app is in a subdirectory (e.g., '/myapp/')
...
return [
	...
	'database' => [
		...
		'dbname'   => 'sinistre',   // Database name (e.g., 'flightphp')
