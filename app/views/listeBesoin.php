...
<div class="container">
    <div class="page-header">
        ...
        <p>Récapitulatif de tous les besoins enregistrés</p>
    </div>

    <div class="card">
        <div class="card-toolbar">
            <span class="count"><strong><?= count($besoins ?? []) ?></strong> besoin(s) enregistré(s)</span>
            <a href="<?= $base_url ?>/formBesoin" class="btn-add">+ Nouveau besoin</a>
        </div>
            ...
            <tbody>
                <?php foreach ($besoins as $besoin): ?>
                    <tr>
                        ...
                        <td><span class="tag tag-blue"><?= htmlspecialchars($besoin['quantite']) ?></span></td>
