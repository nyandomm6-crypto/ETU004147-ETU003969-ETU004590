...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .topbar .brand .logo {
            background: #fff; color: #1a56db; font-weight: 800; font-size: 13px;
            padding: 6px 12px; border-radius: 8px; letter-spacing: 1px;
        }
        .topbar .brand h1 { font-size: 18px; font-weight: 600; }
        nav { display: flex; gap: 8px; }
        nav a {
            color: #fff; text-decoration: none; padding: 8px 16px; border-radius: 8px;
            font-size: 13px; font-weight: 600; background: rgba(255,255,255,0.12); transition: background .2s;
        }
        nav a:hover { background: rgba(255,255,255,0.25); }
        .container { flex: 1; max-width: 900px; width: 100%; margin: 0 auto; padding: 32px 20px; }
        .section-title {
            display: flex; align-items: center; gap: 10px; margin-bottom: 20px;
        }
        .section-title h2 { font-size: 20px; font-weight: 700; color: #0f172a; }
        .section-title .line { flex: 1; height: 2px; background: #cbd5e1; border-radius: 1px; }
        .card {
        ...
        .card-head .dot { display: inline-block; width: 10px; height: 10px; border-radius: 50%; margin-right: 8px; background: #f59e0b; }
        ...
        .btn-achat {
            ...
            text-decoration: none; font-size: 12px; font-weight: 600; transition: transform .15s, box-shadow .2s;
        }
        .btn-achat:hover { transform: translateY(-1px); box-shadow: 0 4px 14px rgba(26,86,219,0.35); }
...
<body>
    ...
    <div class="container">
        <div class="section-title"><h2>Reste des besoins</h2><span class="line"></span></div>
                    ...
                    <tbody>
                        <?php foreach ($besoins as $b): ?>
                            <tr>
                                ...
                                <td><a class="btn-achat" href="">Achat</a></td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
                </table>
